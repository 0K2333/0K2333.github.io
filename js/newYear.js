...
var newYear = () => {
    ...
    // 新年时间戳 and 星期对象
    let newYear = new Date('2025-01-01 00:00:00').getTime() / 1000,
    ...
    function time() {
        ...
        if (second < 0) {
            ...
            document.querySelector('#newYear .newYear-time').innerHTML = '<span class="happyNewYear">2025啦！</p>';
        } else {
            // 大于0则还未过年
            document.querySelector('#newYear .title').innerHTML = '距离元旦假期：'
